...
namespace Loteria
{
	public partial class Form1 : Form
	{
...

		{
			...
			{
				MessageBox.Show("El es 0 y 100");
				
			}

			if (numero1 == n1 && numero2 == n2 && numero3 == n3)
			{
				MessageBox.Show("ganador tripleta");
				
			}

			else if (numero2 > 100)
			{
				MessageBox.Show("El numero es 0 y 100");
			...
			{
				MessageBox.Show("ganador en primera");
				
			}
			else if (numero2 == n2)
			{
				MessageBox.Show("ganador en segunda");
				
			}
			else if (numero3 == n3)
			{
				MessageBox.Show("ganador en 3ra");
				
			}

			dataGridView1.Rows.Add(txt_Nu1.Text, txt_Nu2.Text, txt_Nu3.Text, DateTime.Now);
			...
			for (int i = 0; i <= count - 3; i++)
			{
				...
				if (dataGridView1.Rows[i].Cells[0].Value.ToString() == dataGridView1.Rows[count - 2].Cells[0].Value.ToString())
				{
					...
					data2.Rows.Add(txtrepetido.Text, count - int.Parse(txtrepetido.Text));
				}
